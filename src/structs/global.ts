...
export const PARTICLE_COUNT : number = 20_000_00;
...
export let rawGravityBuffer : SharedArrayBuffer = new SharedArrayBuffer()
export let GravityBuffer : Float32Array = new Float32Array(rawGravityBuffer);
